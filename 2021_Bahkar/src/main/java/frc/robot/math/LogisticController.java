...
public class LogisticController {
     ...
     * @param proportion The value in range [0.0, 1.0] to determine the base response before deviation.
     * @param deviation The value in range [0.0, 1.0] to determine the "stretch" of the logistic adjustment.
     * @param squaring The value in range [0.0, 1.0] to determine the rate of dropoff in the logistic adjustment.
     */
