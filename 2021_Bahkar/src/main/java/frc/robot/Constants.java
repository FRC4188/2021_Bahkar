...
public final class Constants {
    ...
    public static final double PORT_SIDE_LENGTH = Units.feetToMeters(2.5 / (2 * Math.sin(Math.toRadians(60)))); //Side length of the port (Meters).
    ...
    public static final double TURRET_LIMELIGHT_HEIGHT = 1.0; //Height fromt the ground of the limelight (Meters).
    public static final double TURRET_MOUNTING_ANGLE = 0.0; //Verticle angle which the limelight sits at on the turret (Degrees).
